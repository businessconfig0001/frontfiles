...
@section('modals')
    <profile-modal>
        <modal-container :button="{text:'Later',className:'btn btn-secondary'}">
          <div slot="pt">
              ...
              <a href="{{ route('profile.dropbox') }}" class="btn btn-primary dropbox modal-button">Connect to your Dropbox</a>
          ...
          <div slot="en">
            ...
            <p>At the moment we are only testing Dropbox but very soon we will accept almost every type of cloud available.</p>
            <p>FF will store your original files in your Cloud Drive and create a compressed copy with digital watermark and ID. This copy will be stored on our server and fully available on our platform, shareable for non-commercial use with no restrictions.</p>
            <p>We’ll use the compressed file to promote your work. However, you will always have full control over it.
            </p>
            <a href="{{ route('profile.dropbox') }}" class="btn btn-primary dropbox modal-button">Connect to your Dropbox</a>
          </div>      
        </modal-container>
