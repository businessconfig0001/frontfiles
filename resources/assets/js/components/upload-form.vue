...
<div class="form-wrapper">
	...
	<p>
		...
		<input type="" ref="where" name="where" id="where" class="form-control" placeholder="#Where" v-model="upload.data.where" @focus.once="initPlace(upload.index,$event)"/>
